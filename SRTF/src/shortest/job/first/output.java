    ...
    public output(ArrayList<Process> processes) {
        ...
        for (Process process:processes){
            ...
            int arrivalTime=process.getArrivalTime();
               	processes1.add(new Process(processName,timeBurst,arrivalTime));}
        int elapsedTime=0;
...
do {
    ...
    for (Process process : processes1) {
        ...
        calculations.add(new calculations(name, burst, arrival, turnaround, waiting));
        ...
        if (process.anyProcessHasRemainingBurst(processes)) {
           ...
           Collections.sort(processes1, Comparator
                .comparingInt(Process::getTimeBurst));
           break;
    }
    ...
    for (Process process : processes) { 
      ...
      calculations1.add(new calculations(addedName, addedBurst, addedArrival, tat, wt));
    }
